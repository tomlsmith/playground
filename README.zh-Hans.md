...
[打开 Playground](https://tomlsmith.github.io/playground/)，或从源码检出运行工作台。当前源码精确固定 TomlSmith core `0.4.0`；Cargo、CI 与部署会依据 `Cargo.toml` 和 `Cargo.lock` 从 crates.io 获取该版本。
